...
use App\Http\Controllers\Api\V1\PartnerPaymentAccountController;
...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    // Reels backward-compatible public list (V3.8 API surface)
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::group(['prefix' => 'delivery-man','middleware' => 'actch:deliveryman_app'], function () {
            ...
            Route::get('payment-account', [PartnerPaymentAccountController::class, 'show']);
            Route::post('payment-account/{provider}', [PartnerPaymentAccountController::class, 'store']);
    ...
    Route::group(['prefix' => 'config'], function () {
        ...
        Route::get('get-active-payment-gateway', 'ConfigController@getActivePaymentGateway');
    ...
    Route::post('client-logs', 'ClientLogController@store');
    ...
    Route::group(['middleware'=>['module-check']], function(){
        ...
        Route::group(['prefix' => 'customer', 'middleware' => 'apiGuestCheck'], function () {
            Route::group(['prefix' => 'order'], function () {
                ...
                Route::post('payment-session', 'PaymentSessionController@store');
                Route::get('payment-session/{sessionId}', 'PaymentSessionController@show');
                Route::post('payment-session/{sessionId}/charge', [\App\Http\Controllers\Api\V1\PaymentChargeController::class, 'store']);
                Route::post('mangopay-card-registration', [\App\Http\Controllers\Api\V1\MangoPayCardRegistrationController::class, 'store']);
        ...
        Route::controller(PartnerPaymentAccountController::class)->group(function () {
            Route::get('payment-account', 'show');
            Route::post('payment-account/{provider}', 'store');
        });
    });
